...
// hide-show javascript part
function myFunctionshow() {
  var x = document.getElementById("instafeed-container");
  var btnText = document.getElementById("myBtnshow");

  if (x.style.display === "none") {
    x.style.display = "block";
    btnText.innerHTML = "Hide";
    btnText.style="color:#ef6603; border: 2px solid #ef6603;padding: 4px 70px 4px 26px;border-radius:25px;"; 
